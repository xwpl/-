...
<html>
	<head>
		...
		<script language="javascript">
			...
			function choose1(form1){
				form1.change=form1.radio[0].value;
			}
			function choose2(form1){
				form1.change=form1.radio[1].value;
			}
		</script>
	</head>
	<body>
						...
						<tr>
							...
							<td>
								<a style="CURSOR: hand" href="javascript:checkName()"> <IMG
										alt=现在登录 src="html/pic/reg2.gif" width=75 border=0></a>
								 <label><input name="radio" onclik="choose1(form1)" type="radio" value="0" />老师</label> 
								<label><input name="radio" onclik="choose2(form1)" type="radio" value="1" />学生 </label> 	
